...
## เรื่องที่ควรรู้ !
- หากต้องการ ปรับ Plan, Branch, Parcel ที่ต้องการแสดงผล สามารถเข้าไปปรับได้ใน environment.development.ts
- เนื่องจากใน demo นี้ไม่มี ฟีเจอร์ในการสร้าง Plan, Branch, Parcel หากไปสร้าง ใน Arcgis Urban เเละ เปลี่ยน Id ใน environment.development.ts เเล้ว เเต่ยังไม่ขึ้นบนแผนที่ ให้ปรับ การมองเห็นของส่วนประกอบต่างๆ เป็น public ซึ่งสามารถทำได้ใน Arcgis Online 
